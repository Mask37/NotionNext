...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '疯人院里的疯言疯语', // 您的昵称 例如 tangly1024
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/Mask37', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  NOTION_HOST: process.env.NEXT_PUBLIC_NOTION_HOST || '', // Notion域名，您可以选择用自己的域名进行反向代理，如果不懂得什么是反向代理，请勿修改此项，https://www.notion.so
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '苏ICP备2022001708号-1', // 备案号 闽ICP备XXXXXXX
  ...
  MUSIC_PLAYER_METING_ID:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '2811031169', // 对应歌单的 id
